...
import sharath.reader.mycomponent.MyStreamReaderImpl
import sharath.transformer.mycomponent.MyStreamTransformerImpl
import sharath.writer.mycomponent.MyStreamWriterImpl
